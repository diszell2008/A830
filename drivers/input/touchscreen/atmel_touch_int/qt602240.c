...
#include "../../../../include/pantech/BOARD_REV.h" // mirinae_20110920
#include "qt602240.h"
...
static int __devinit qt602240_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	set_bit(KEY_MESSAGE, qt602240_data->input_dev->keybit); // p11223_Key
	set_bit(KEY_BROWSER, qt602240_data->input_dev->keybit); // p11223_Key
...
module_i2c_driver(qt602240_driver);
